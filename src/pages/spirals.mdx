...
<details>
    ...
    little lines. Take a look [here](https://www.youtube.com/watch?v=X8N21DrWmjU).
</details>
...
To actually rotate it, we can plug this into the anticlockwise rotation matrix. We want to turn it anticlockwise because the wheel already turns in the anticlockwise direction, so yeah mhm.
...
**_Ding, Dong, it's Desmos Song!_**

<Desmos link="https://www.desmos.com/calculator/uyib54f0gc" />

(As you can see, the major down-side here is that it's not the easiest on the old silicon)
