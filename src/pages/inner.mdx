...
<img
    src="/spirographs/assets/inner1.jpg"
    alt="diagram with circular track and the starting position of the tracing wheel"
/>
...
<img
    src="/spirographs/assets/inner3.jpg"
    alt="diagram with the ending position of the tracing wheel and triangles showing the position of points M and P"
/>
...
P_y &= (R - r)sin(\alpha) - Dcos(\alpha\frac{R - r}{r} - \frac{\pi}{2}) \\
    &= (R - r)sin(\alpha) - Dcos(\frac{\pi}{2} - \alpha\frac{R - r}{r}) \\
...
<Desmos link="https://www.desmos.com/calculator/18jbfpsftd" />
...
<img src="/spirographs/assets/inner5.jpg" alt="a model of one of the spirograph gears showing the spiral pattern of the holes" />
...
<img src="/spirographs/assets/inner6.jpg" alt="an alternate diagram of the spirograph gear aligning the holes into a straight line" />

Where

-   $H$ is the total number of holes on the small gear
-   $P$ is the hole number chosen for the pen

Now we can substitute $D=r\frac{H + 1 - P}{H + 1}$. Another thing to note, if we scale $R$ and $r$ by an equal amount, then the graph itself will get bigger but shape won't change. This means that you can replace $R$ with the number of teeth of the outer wheel, and $r$ with the number of teeth on the rotating wheel and the equation will still work!

$$
\begin{align}
P_x &= (R - r)cos(\alpha) + r\frac{H + 1 - P}{H + 1}cos(\alpha\frac{R - r}{r}) \\
P_y &= (R - r)sin(\alpha) - r\frac{H + 1 - P}{H + 1}sin(\alpha\frac{R - r}{r}) \\
\end{align}
$$

We can play with this in Desmos too!

<Desmos link="https://www.desmos.com/calculator/q533hi6mvk" />
